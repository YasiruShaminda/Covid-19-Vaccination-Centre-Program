...
public class VaccinationCentre
{
    ...
    public static void addPatient()
    {
        ...
        booth[boothNumber-1].setFirstName(input.next());

        System.out.println("Patient's Surname : ");
        booth[boothNumber-1].setSurName(input.next());

        System.out.println("Patient's Age : ");
        booth[boothNumber-1].setAge(input.nextInt());

        System.out.println("Your NIC/Passport Id : ");
        booth[boothNumber-1].setIdNumber(input.next());

        System.out.println("Your City : ");
        booth[boothNumber-1].setCity(input.next());
